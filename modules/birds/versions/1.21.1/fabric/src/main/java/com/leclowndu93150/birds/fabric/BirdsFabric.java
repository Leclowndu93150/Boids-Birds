...
public class BirdsFabric implements ModInitializer {
    ...
    public void onInitialize() {
        ...
        EntityType<Bird> birdType = Registry.register(
            ...
            Birds.id("bird"),
            EntityType.Builder.of(Bird::new, MobCategory.AMBIENT).sized(1.5f, 0.6f).clientTrackingRange(16).build()
        );
        Birds.BIRD = birdType;
        ...
        SpawnPlacements.register(birdType, SpawnPlacementTypes.ON_GROUND, Heightmap.Types.MOTION_BLOCKING, Bird::checkAnimalSpawnRules);
